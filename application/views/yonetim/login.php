				...
				<div class="auth-box">
					<div class="left" style="box-shadow: 0 0 2px 0 rgba(0, 0, 0, 0.1), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
						<div class="content col-xs-12" style="margin-top:50px;">
							...
							<?php echo validation_errors(); ?><!--hata mesajını yazdırıyoruz-->
							<?php echo $this->session->flashdata('hata'); ?><!--Session kontrol hatasını yazdırıyoruz.-->

							<form class="form-auth-small" action="<?php echo base_url('yonetim/login'); ?>" method="POST">
								<div class="form-group">
									<input type="text" class="form-control" id="signup-email" name="kadi" placeholder="Kullanıcı Adı" value="Ender İMEN" required="required" autofocus>
								</div>
								<div class="form-group">
