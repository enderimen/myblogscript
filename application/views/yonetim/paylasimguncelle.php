			...
			<div class="main-content">
				<div class="container-fluid">
							...
							<div class="panel col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								<form action="<?php echo base_url('yonetimpaneli/paylasimduzenle'); echo '/'.$inf->paylasimID ?>" method="POST" enctype="multipart/form-data">
								
									<div class="form-group col-md-8">
										<h4>Gönderi Başlığı</h4>
										<input type="text" class="form-control" name="paylasim_baslik" value="<?php echo $inf->paylasim_baslik; ?>" required>
									</div>
									<div class="form-group col-md-4">
										<h4>Staj Günü</h4>
										<input type="text" class="form-control" name="paylasim_gunu"  value="<?php echo $inf->staj_gunu; ?>" required>
									</div>
									<div class="form-group col-md-12">
										<h4>Gönderi İçeriği</h4>
										<textarea type="text" name="paylasim_yazisi" class="ckeditor"><?php echo $inf->paylasim_yazisi; ?></textarea> <!--BOYUT ESNEK OLACAK-->
										<br>									
									</div>
									<div class="form-group col-lg-4 col-md-12 col-sm-12 col-xs-12 pull-right">
										<input type="submit" value="Güncelle" class="btn btn-warning col-lg-12 col-md-12 col-sm-12 col-xs-12" name="btn-paylasim-guncelle">	
									</div>
								</form>
							</div>
							<!-- END INPUTS -->
